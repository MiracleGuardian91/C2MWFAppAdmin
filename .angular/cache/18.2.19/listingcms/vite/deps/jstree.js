    ...
    (function(factory) {
      ...
      $.jstree.core.prototype = {
        ...
        _load_node: function(obj, callback) {
          ...
          if (typeof s === "object") {
            if (s.url) {
              ...
              return $.ajax(s).done(function(d, t2, x) {
        ...
        _append_json_data: function(dom, data, cb, force_processing) {
          ...
          var w = null, args = {
          ...
          }, inst = this, func = function(data2, undefined2) {
            if (data2.data) {
              data2 = data2.data;
            }
            var dat = data2.dat, par = data2.par, chd = [], dpc = [], add = [], df = data2.df, t_id = data2.t_id, t_cnt = data2.t_cnt, m = data2.m, p = m[par], sel = data2.sel, tmp, i, j, rslt2, parse_flat = function(d, p2, ps) {
              ...
              if (tmp2.icon === undefined2 || tmp2.icon === null || tmp2.icon === "") {
                tmp2.icon = true;
              }
              if (d && d.data) {
                tmp2.data = d.data;
            ...
            if (dat.length && dat[0].id !== undefined2 && dat[0].parent !== undefined2) {
        ...
        get_top_selected: function(full) {
          ...
          return full ? $.map(tmp, function(i2) {
        ...
        get_bottom_selected: function(full) {
          ...
          return full ? $.map(obj, function(i2) {
            return this.get_node(i2);
          }.bind(this)) : obj;
        },
        /**
            ...
            if (state.core) {
              ...
              if (state.core.selected) {
                ...
                if (state.core.initial_selection === undefined || state.core.initial_selection === this._data.core.selected.concat([]).sort().join(",")) {
                  this.deselect_all();
                  $.each(state.core.selected, function(i2, v) {
        ...
        cut: function(obj) {
          ...
          for (t1 = 0, t2 = obj.length; t1 < t2; t1++) {
            ...
            if (o && (o.id || o.id === 0) && o.id !== $.jstree.root) {
              tmp.push(o);
            }
          }
          if (!tmp.length) {
        ...
        copy: function(obj) {
          ...
          for (t1 = 0, t2 = obj.length; t1 < t2; t1++) {
            o = this.get_node(obj[t1]);
            if (o && o.id !== undefined && o.id !== $.jstree.root) {
              tmp.push(o);
            }
          }
          if (!tmp.length) {
      ...
      (function($2) {
        ...
        $2.vakata.context = {
          ...
          _trigger: function(event_name) {
            $2(document).triggerHandler("context_" + event_name + ".vakata", {
          ...
          _execute: function(i) {
            ...
            return i && (!i._disabled || $2.vakata.is_function(i._disabled) && !i._disabled({
              "item": i,
              "reference": vakata_context.reference,
              "element": vakata_context.element
          ...
          _parse: function(o, is_callback) {
            ...
            $2.each(o, function(i, val) {
              if (!val) {
                return true;
              }
              vakata_context.items.push(val);
              if (!sep && val.separator_before) {
                str += "<li class='vakata-context-separator'><a href='#' " + ($2.vakata.context.settings.icons ? "" : 'class="vakata-context-no-icons"') + ">&#160;</a></li>";
              }
              sep = false;
              str += "<li class='" + (val._class || "") + (val._disabled === true || $2.vakata.is_function(val._disabled) && val._disabled({
                "item": val,
                "reference": vakata_context.reference,
                "element": vakata_context.element
              }) ? " vakata-contextmenu-disabled " : "") + "' " + (val.shortcut ? " data-shortcut='" + val.shortcut + "' " : "") + ">";
              str += "<a href='#' rel='" + (vakata_context.items.length - 1) + "' " + (val.title ? "title='" + val.title + "'" : "") + ">";
              if ($2.vakata.context.settings.icons) {
                str += "<i ";
                if (val.icon) {
              ...
              str += ($2.vakata.is_function(val.label) ? val.label({
                "item": i,
                "reference": vakata_context.reference,
                "element": vakata_context.element
              ...
              if (val.submenu) {
                tmp = $2.vakata.context._parse(val.submenu, true);
                if (tmp) {
                  str += tmp;
                }
              }
            ...
            if (!is_callback) {
              ...
              $2.vakata.context._trigger("parse");
            }
          ...
          _show_submenu: function(o) {
            ...
            var e = o.children("ul"), xl = o.offset().left, x = xl + o.outerWidth(), y = o.offset().top, w = e.width(), h = e.height(), dw = $2(window).width() + $2(window).scrollLeft(), dh = $2(window).height() + $2(window).scrollTop();
            if (right_to_left) {
          ...
          show: function(reference, position, data) {
            ...
            if (!!reference && !data && $2(reference).data("vakata_contextmenu")) {
              data = $2(reference).data("vakata_contextmenu");
            }
            if ($2.vakata.context._parse(data)) {
            ...
            if (vakata_context.items.length) {
              ...
              w = e.width();
              h = e.height();
              dw = $2(window).width() + $2(window).scrollLeft();
              dh = $2(window).height() + $2(window).scrollTop();
              if (right_to_left) {
                x -= e.outerWidth() - $2(reference).outerWidth();
                if (x < $2(window).scrollLeft() + 20) {
                  x = $2(window).scrollLeft() + 20;
                }
              }
              if (x + w + 20 > dw) {
                x = dw - (w + 20);
              ...
              $2.vakata.context._trigger("show");
            }
          },
          hide: function() {
            if (vakata_context.is_visible) {
              ...
              $2.vakata.context._trigger("hide");
            }
          }
        };
        $2(function() {
          right_to_left = $2(document.body).css("direction") === "rtl";
          var to2 = false;
          vakata_context.element = $2("<ul class='vakata-context'></ul>");
          vakata_context.element.on("mouseenter", "li", function(e) {
            e.stopImmediatePropagation();
            if ($2.contains(this, e.relatedTarget)) {
              return;
            }
            if (to2) {
              clearTimeout(to2);
            ...
            $2(this).siblings().find("ul").hide().end().end().parentsUntil(".vakata-context", "li").addBack().addClass("vakata-context-hover");
            $2.vakata.context._show_submenu(this);
          }).on("mouseleave", "li", function(e) {
            if ($2.contains(this, e.relatedTarget)) {
              return;
            }
            $2(this).find(".vakata-context-hover").addBack().removeClass("vakata-context-hover");
          }).on("mouseleave", function(e) {
            $2(this).find(".vakata-context-hover").removeClass("vakata-context-hover");
            if ($2.vakata.context.settings.hide_onmouseleave) {
              to2 = setTimeout(/* @__PURE__ */ function(t) {
                return function() {
                  $2.vakata.context.hide();
                };
              }(this), $2.vakata.context.settings.hide_onmouseleave);
            }
          }).on("click", "a", function(e) {
            e.preventDefault();
            if (!$2(this).trigger("blur").parent().hasClass("vakata-context-disabled") && $2.vakata.context._execute($2(this).attr("rel")) !== false) {
              $2.vakata.context.hide();
            }
          ...
          $2(document).on("mousedown.vakata.jstree", function(e) {
            if (vakata_context.is_visible && vakata_context.element[0] !== e.target && !$2.contains(vakata_context.element[0], e.target)) {
              $2.vakata.context.hide();
            }
      ...
      $.jstree.plugins.dnd = function(options, parent) {
        ...
        this.bind = function() {
          ...
          this.element.on(this.settings.dnd.use_html5 ? "dragstart.jstree" : "mousedown.jstree touchstart.jstree", this.settings.dnd.large_drag_target ? ".jstree-node" : ".jstree-anchor", function(e) {
            ...
            if (obj && (obj.id || obj.id === 0) && obj.id !== $.jstree.root && (e.which === 1 || e.type === "touchstart" || e.type === "dragstart") && (this.settings.dnd.is_draggable === true || $.vakata.is_function(this.settings.dnd.is_draggable) && this.settings.dnd.is_draggable.call(this, mlt > 1 ? this.get_top_selected(true) : [obj], e))) {
              drg = {
                "jstree": true,
                "origin": this,
                "obj": this.get_node(obj, true),
      ...
      $(function() {
        ...
        $(document).on("dragover.vakata.jstree", function(e) {
          ...
          lastev = data.event;
          var ins = $.jstree.reference(data.event.target), ref = false, off = false, rel = false, tmp, l, t, h, p, i, o, ok, t1, t2, op, ps, pr, ip, tm, is_copy, pn, c;
      ...
      (function($2) {
        $2.vakata.html = {
          div: $2("<div></div>"),
          escape: function(str) {
            return $2.vakata.html.div.text(str).html();
          },
          strip: function(str) {
            return $2.vakata.html.div.empty().append($2.parseHTML(str)).text();
          }
        };
        var vakata_dnd = {
          element: false,
        ...
        $2.vakata.dnd = {
          ...
          _trigger: function(event_name, e, data) {
            ...
            data.event = e;
            $2(document).triggerHandler("dnd_" + event_name + ".vakata", data);
          },
          _get: function() {
            return {
          ...
          _clean: function() {
            ...
            elm = null;
            $2(document).off("mousemove.vakata.jstree touchmove.vakata.jstree", $2.vakata.dnd.drag);
            $2(document).off("mouseup.vakata.jstree touchend.vakata.jstree", $2.vakata.dnd.stop);
          },
          _scroll: function(init_only) {
            ...
            if (!vakata_dnd.scroll_i) {
              vakata_dnd.scroll_i = setInterval($2.vakata.dnd._scroll, 100);
              return false;
            }
            if (init_only === true) {
              return false;
            ...
            vakata_dnd.scroll_e.scrollTop(i + vakata_dnd.scroll_t * $2.vakata.dnd.settings.scroll_speed);
            vakata_dnd.scroll_e.scrollLeft(j + vakata_dnd.scroll_l * $2.vakata.dnd.settings.scroll_speed);
            if (i !== vakata_dnd.scroll_e.scrollTop() || j !== vakata_dnd.scroll_e.scrollLeft()) {
              $2.vakata.dnd._trigger("scroll", vakata_dnd.scroll_e);
            }
          },
          start: function(e, data, html) {
            ...
            if (html !== false) {
              vakata_dnd.helper = $2("<div id='vakata-dnd'></div>").html(html).css({
                "display": "block",
                "margin": "0",
                "padding": "0",
                "position": "absolute",
            ...
            $2(document).on("mousemove.vakata.jstree touchmove.vakata.jstree", $2.vakata.dnd.drag);
            $2(document).on("mouseup.vakata.jstree touchend.vakata.jstree", $2.vakata.dnd.stop);
            return false;
          },
          drag: function(e) {
            ...
            if (!vakata_dnd.is_drag) {
              if (Math.abs(e.pageX - vakata_dnd.init_x) > (vakata_dnd.is_touch ? $2.vakata.dnd.settings.threshold_touch : $2.vakata.dnd.settings.threshold) || Math.abs(e.pageY - vakata_dnd.init_y) > (vakata_dnd.is_touch ? $2.vakata.dnd.settings.threshold_touch : $2.vakata.dnd.settings.threshold)) {
                if (vakata_dnd.helper) {
                  vakata_dnd.helper.appendTo(document.body);
                  vakata_dnd.helper_w = vakata_dnd.helper.outerWidth();
                }
                vakata_dnd.is_drag = true;
                $2(vakata_dnd.target).one("click.vakata", false);
                $2.vakata.dnd._trigger("start", e);
              } else {
                return;
              }
            }
            ...
            $2($2(e.target).parentsUntil("body").addBack().get().reverse()).filter(function() {
              return this.ownerDocument && /^auto|scroll$/.test($2(this).css("overflow")) && (this.scrollHeight > this.offsetHeight || this.scrollWidth > this.offsetWidth);
            }).each(function() {
              var t = $2(this), o = t.offset();
              if (this.scrollHeight > this.offsetHeight) {
                if (o.top + t.height() - e.pageY < $2.vakata.dnd.settings.scroll_proximity) {
                  vakata_dnd.scroll_t = 1;
                }
                if (e.pageY - o.top < $2.vakata.dnd.settings.scroll_proximity) {
                  vakata_dnd.scroll_t = -1;
                }
              }
              if (this.scrollWidth > this.offsetWidth) {
                if (o.left + t.width() - e.pageX < $2.vakata.dnd.settings.scroll_proximity) {
                  vakata_dnd.scroll_l = 1;
                }
                if (e.pageX - o.left < $2.vakata.dnd.settings.scroll_proximity) {
                  vakata_dnd.scroll_l = -1;
                }
              }
              if (vakata_dnd.scroll_t || vakata_dnd.scroll_l) {
                vakata_dnd.scroll_e = $2(this);
                return false;
              }
            });
            if (!vakata_dnd.scroll_e) {
              ...
              dt = d.scrollTop();
              dl = d.scrollLeft();
              if (dh > wh && e.pageY - dt < $2.vakata.dnd.settings.scroll_proximity) {
                vakata_dnd.scroll_t = -1;
              }
              if (dh > wh && wh - (e.pageY - dt) < $2.vakata.dnd.settings.scroll_proximity) {
                vakata_dnd.scroll_t = 1;
              }
              if (dw > ww && e.pageX - dl < $2.vakata.dnd.settings.scroll_proximity) {
                vakata_dnd.scroll_l = -1;
              }
              if (dw > ww && ww - (e.pageX - dl) < $2.vakata.dnd.settings.scroll_proximity) {
                vakata_dnd.scroll_l = 1;
              }
              if (vakata_dnd.scroll_t || vakata_dnd.scroll_l) {
            ...
            if (vakata_dnd.scroll_e) {
              $2.vakata.dnd._scroll(true);
            }
            if (vakata_dnd.helper) {
              ht = parseInt(e.pageY + $2.vakata.dnd.settings.helper_top, 10);
              hl = parseInt(e.pageX + $2.vakata.dnd.settings.helper_left, 10);
              if (dh && ht + 25 > dh) {
                ht = dh - 50;
              }
          ...
          stop: function(e) {
            ...
            if (vakata_dnd.is_drag) {
              if (e.target !== vakata_dnd.target) {
                $2(vakata_dnd.target).off("click.vakata");
              }
              $2.vakata.dnd._trigger("stop", e);
            } else {
              if (e.type === "touchend" && e.target === vakata_dnd.target) {
                var to2 = setTimeout(function() {
                  $2(e.target).trigger("click");
                }, 100);
                $2(e.target).one("click", function() {
                  if (to2) {
                    clearTimeout(to2);
                  }
                });
      ...
      $.jstree.plugins.search = function(options, parent) {
        ...
        this.search = function(str, skip_async, show_only_matches, inside, append, show_only_matches_children) {
          ...
          $.each(m[inside ? inside : $.jstree.root].children_d, function(ii, i2) {
            var v = m[i2];
      ...
      (function($2) {
        $2.vakata.search = function(pattern, txt, options) {
          options = options || {};
          options = $2.extend({}, $2.vakata.search.defaults, options);
      ...
      $.jstree.plugins.types = function(options, parent) {
        this.init = function(el, options2) {
          ...
          if (options2 && options2.types && options2.types["default"]) {
            for (i in options2.types) {
              if (i !== "default" && i !== $.jstree.root && options2.types.hasOwnProperty(i)) {
                for (j in options2.types["default"]) {
                  if (options2.types["default"].hasOwnProperty(j) && options2.types[i][j] === undefined) {
        ...
        this.get_json = function(obj, options2, flat) {
          var i, j, m = this._model.data, opt = options2 ? $.extend(true, {}, options2, {
            no_id: false
