...
import { ApplicationService, BMConditionService, DmoControlService, ListviewService, MessageService } from '@app/core';
...
export class ChildFormViewComponent implements OnInit {
  ...
  private getBMWFJson() {
    this.formViewApi.getFormData(this.processName, this.CanvasType, this.transactionId).subscribe(response => {
