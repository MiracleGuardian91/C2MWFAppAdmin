export interface EventBus {
  ...
  on: {
    (events: string | string[], callback: EventBusEventCallback<any>, that?: any): void;
    (events: string | string[], priority: number, callback: EventBusEventCallback<any>, that?: any): void;
  };
  once: {
