import { ConnectionShape, DiagramEl, EventDef, Point ,Parent,Label,Shape} from "./element.model";
import { Moddle } from "./moddle.model";



export interface Modeling<T extends ConnectionShape, U extends DiagramEl, V extends Label, W extends Parent, X extends Shape> {
  ...
  createShape(shape: Partial<X>, position: Point, target: W, parentIndex: number, hints?: any): X;
  ...
  moveShape(shape: X, delta: Point, newParent?: W, newParentIndex?: number, hints?: any): void;
  updateAttachment(shape: X, newHost?: X): void;
  moveConnection(connection: T, delta: Point, newParent?: W, newParentIndex?: number, hints?: any): void;
  createConnection(
    source: U,
    target: U,
  ...
  createConnection(
   ...
   createElements(elements: Partial<U>[], position: Point, parent: W, parentIndex?: number, hints?: any): U[];
  createLabel(labelTarget: U, position: Point, label: Partial<V>, parent?: W): V;
  appendShape(source: U, shape: Partial<X>, position: Point, target: W, hints?: any): X;
  ...
  createSpace(movingShapes: X[], resizingShapes: X[], delta: Point, direction: any, start: number): void;
  reconnect(connection: T, source: U, target: U, dockingOrPoints: Point | Point[], hints?: any): void;
  reconnectStart(connection: T, newSource: U, dockingOrPoints: Point | Point[], hints?: any): void;
  reconnectEnd(connection: T, newTarget: U, dockingOrPoints: Point | Point[], hints?: any): void;
  ...
  makeProcess(): void;
  setColor: (elements: DiagramEl[], colors: {stroke: string; fill: string; strokeWidth?: number; fillOpacity?: number; }) => void;
  ...
  resizeLane: (laneShape: X, newBounds: any, balanced?: boolean, hints?: any) => void;
  getHandlers(): any;
