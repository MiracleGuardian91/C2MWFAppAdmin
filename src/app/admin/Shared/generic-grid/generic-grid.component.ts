...
import { formatDate, NgIf, NgStyle, NgFor, NgClass, NgSwitch, NgSwitchCase, NgSwitchDefault, CurrencyPipe, KeyValuePipe } from '@angular/common';
import { NgbDateParserFormatter, NgbDateStruct, NgbModal, NgbDropdown, NgbDropdownToggle, NgbDropdownMenu, NgbInputDatepicker, NgbDropdownItem, NgbPopover } from '@ng-bootstrap/ng-bootstrap';
...
@Component({
    ...
    standalone: true,
    imports: [NgIf, CdkDropListGroup, ReactiveFormsModule, FormsModule, NgStyle, NgFor, NgbDropdown, NgbDropdownToggle, NgbDropdownMenu, NgClass, NgbInputDatepicker, NgbDropdownItem, NgSwitch, NgSwitchCase, NgbPopover, NgSwitchDefault, CurrencyPipe, KeyValuePipe]
})
export class GenericGridComponent {
  ...
  @Output() actionsMenuOpen = new EventEmitter<{x:number,y:number,rowIndex:number}>();
  ...
  arrangeArrowUrl = UtilService.getUrlForImage('/assets/styles/images/arrange-arrow.png');
...
//MD Changes - #444 & CRM #961 
  ...
  openActionsMenu(evt: MouseEvent, rowIndex: number) {
